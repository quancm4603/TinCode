                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="navbar-nav justify-content-between ms-auto" style="width: 50%;margin-left: 5px;height: auto;">
                            ...
                            <li class="nav-item" style="min-width: 20%;height: auto;margin-right: 0px;">
                                <a class="btn btn-outline-dark active" role="button" id="button-addon-3" style="height: auto;padding: 0;border-style: solid;backdrop-filter: opacity(1);width: auto;padding: 10px;" href="./contribute">Đóng góp</a>
                            </li>
