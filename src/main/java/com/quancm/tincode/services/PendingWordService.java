...
public class PendingWordService {
    ...
    private static final String INSERT_WORD_SQL = "INSERT INTO pendingwords (word, definition, original, example) VALUES (?, ?, ?, ?)";
    private static final String SELECT_WORD_BY_ID = "SELECT * FROM pendingwords WHERE id = ?";
    private static final String SELECT_ALL_WORDS = "SELECT * FROM pendingwords";
    private static final String DELETE_WORD_SQL = "DELETE FROM pendingwords WHERE id = ?";
    private static final String UPDATE_WORD_SQL = "UPDATE pendingwords SET word = ?, definition = ?, original = ?, example = ? WHERE id = ?";

    public PendingWordService() {
    }
